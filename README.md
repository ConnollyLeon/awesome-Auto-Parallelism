...
## Data Parallelism
## Model Parallelism
To differ model parallelism from pipeline parallelism, here  model parallelism represents 
for tensor parallelism (some people may call it parameter parallelism or intra-layer model parallelism).

## Pipeline Parallelism
Here pipeline parallelism also named as inter-layer model parallelism, because their partitions
are the same, but have some difference in executing schedule.
